...
interface MessageService {
    @GET("conversations/{conversationId}/{currentUserId}/messages")
    fun getMessages(
...
class MessengerActivity : AppCompatActivity() {
    ...
    private lateinit var sendername: String // Store the conversation ID
    private lateinit var senderimage: String // Store the conversation ID
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var senderimageui = findViewById<ImageView>(R.id.photo)
...
//            displayAttachments()
//        }
        senderimageui.setImageResource(R.drawable.greg)
        ...
        val apiKey = "80e01067bd82ddb68ce5091bd07c8e1946ef4626" // Replace with your method to get the dynamic API key
        ...
        service.getMessages(conversationId, currentUserId).enqueue(object : Callback<Conversation2> {
        ...
        if (File(filePath).exists()) {
            CoroutineScope(Dispatchers.IO).launch {
                try {
                    ...
                    val url = URL("http://10.0.2.2:8080/conversations/$conversationId/attachments")
